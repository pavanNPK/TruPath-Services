    ...
    try {
        await transporter.sendMail({
            ...
            <div style="background: linear-gradient(135deg, #051C3B, #163560); padding: 28px 20px; text-align: center; animation: fadeInHeader 1.5s ease forwards;">
                <img src="https://www.trupathservices.com/assets/images/core/logo-invert.svg" alt="TruPath Services" style="max-height: 50px; display: block; margin: 0 auto 10px auto;">
            ...
            <!-- Embedded Keyframe Animations (safe for most modern email clients) -->
            <style>
